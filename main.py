...
from api_keys import get_mongodb_uri, get_google_cse_key, get_google_cse_cx, get_bing_key, get_github_token
...
short_term_memory = ""
model = st.sidebar.selectbox("Select OpenAI model", ("davinci-codex", "davinci-instruct-beta"))
...
if send_button:
    if "search" in user_input.lower():
        ...
        search_results = {"google": google_search(query, google_cse_key, google_cse_cx), "bing": bing_search(query, bing_key), "github": github_search(query, github_token)}

...
models = {"ChatGPT": ChatGPT(), "CodexGPT": CodexGPT(), "InstructGPT": InstructGPT()}
...
with st.form("chat_form"):
    ...
    if send_button:
        if "search" in user_input.lower():
            ...
            search_results = {"google": google_search(query, google_cse_key, google_cse_cx), 
            ...
            chatgpt_response = model.get_response(user_input, short_term_memory)
